...
def run_parking_dwell_state(
    ...
    # 4) score: plus de dwell_stop augmente, plus de move_hits diminue
    #    (tu peux changer pour pénaliser par temps en move si tu connais la vitesse)
    score_grid = w_stop * dwell_stop - w_move * move_hits
